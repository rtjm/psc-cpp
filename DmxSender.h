...
class DmxSender {
    ...
    public:
        ...
        DmxSender(bool activesender) 
		{ 
			_activesender = activesender;
			...
			//ss->RegisterRepeatingTimeout(tick_interval, ola::NewCallback(&SendDmxFrame, &wrapper));
		...
		static bool SendDmxFrame(ola::client::OlaClientWrapper *wrapper)
		{
